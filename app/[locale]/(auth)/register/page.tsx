...
router.push(`/${locale}/${formData.role}/dashboard`)
}
}, [mounted, isAuthenticated, locale, formData.role, router])
...
try {
  ...
  console.log("Error message:", error)  // Debug log
        ...
        <div className="w-full">
          ...
          <div className="relative">
            <select
              ...
              onChange={handleChange}
              disabled={isLoading}
              className="w-full px-4 py-2.5 border-2 rounded-lg outline-none transition-all focus:border-primary border-gray-300 bg-white cursor-pointer"
            >
